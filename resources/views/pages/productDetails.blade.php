				...
				<div class="single-product-details">
					...
					<div class="product-quantity">
						...
						<div class="product-quantity-slider">
							<input id="product-quantity" type="text" value="" name="product-quantity">
						</div>
					</div>
			...
			<div class="col-md-3">
				<div class="product-item">
					<div class="product-thumb">
						...
						<img class="img-responsive" src="https://i.ytimg.com/vi/TNHXfys3Dak/maxresdefault.jpg" alt="product-img" />
